...
<head>
    <meta charset="UTF-8">
    <title>Edit Course | SMS ADMIN</title>
...
<body>
    ...
    <div class="form-card-wrapper">
        <div class="form-card">
            <h1 style="text-align: left; margin-bottom: 0.5rem;">Edit Course</h1>
            <p class="subtitle" style="text-align: left; margin-bottom: 2rem;">Updating details for #<%= c.getCourseId() %></p>
            ...
            <form action="${pageContext.request.contextPath}/course/update" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="courseName" name="courseName" value="<%= c.getCourseName() %>" required>
                </div>
                <div class="form-group">
                    <label for="duration">Duration</label>
                    <input type="text" id="duration" name="duration" value="<%= c.getDuration() %>" required>
                </div>
                <div class="form-group">
                    <label for="fees">Fees ($)</label>
                    <input type="number" step="0.01" id="fees" name="fees" value="<%= c.getFees() %>" required>
                </div>
                <div class="form-group">
                    <label for="trainerName">Trainer Name</label>
                    <input type="text" id="trainerName" name="trainerName" value="<%= c.getTrainerName() %>" required>
                </div>
                <button type="submit" style="margin-top: 1rem;">Update Course</button>
            </form>
            <a href="${pageContext.request.contextPath}/courses" class="back-link">← Cancel and Go Back</a>
        </div>
    </div>
</body>
</html>
