...
public class AddCourseServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        System.out.println("[LIFECYCLE] AddCourseServlet: init() called. CourseDAO initialized.");
     ...
     protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("[LIFECYCLE] AddCourseServlet: doGet() called. Loading course form.");
     ...
     protected void doPost(HttpServletRequest request, HttpServletResponse response)
             throws ServletException, IOException {
        System.out.println("[LIFECYCLE] AddCourseServlet: doPost() called. Creating new course.");
    ...
    @Override
    public void destroy() {
        System.out.println("[LIFECYCLE] AddCourseServlet: destroy() called.");
    }
}
